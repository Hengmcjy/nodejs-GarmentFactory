...
@Component({
    selector: 'app-smd-customer-card',
    templateUrl: './smd-customer-card.component.html',
    styleUrls: ['./smd-customer-card.component.scss'],
})
export class SmdCustomerCardComponent implements OnInit, OnDestroy  {
